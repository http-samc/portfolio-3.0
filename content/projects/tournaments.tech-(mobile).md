...
Get the tournaments.tech app on the [Play Store](?) or the [App Store](?), or access it anywhere at [tournaments.tech](http://tournaments.tech)!
...
You can check out the source code on GitHub at [http-samc/tournaments.tech-mobile](https://github.com/tournaments.tech-mobile).
